...
import { CustomJWTPayload, CustomRequest } from "../types/general"
...
export default class AuthMiddleware {
	public static async authenticateToken(req: CustomRequest, res: Response, next: NextFunction) {
		try {
	...
	public static async authenticateAdmin(req: CustomRequest, res: Response, next: NextFunction) {
		try {
